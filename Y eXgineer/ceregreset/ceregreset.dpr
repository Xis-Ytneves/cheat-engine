...
begin
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            reg.closekey;
            reg.OpenKey('\Software\Y eXgineer', false);
          end;
    ...
    if needsToSaveStuff=false then
      reg.DeleteKey('\Software\Y eXgineer'); //get rid of the whole key

    if not silent then
      messagebox(0,'Successfully reset the settings of Y eXgineer','Registry Reset',0);
