...
uses
  ...
  LuaHandler, frmLuagineerUnit, frmMemviewPreferencesUnit,
  ...
  LuaeXComponent, LuaAddresslist, frmDriverLoadedUnit, memdisplay,
  ...
  LuaHeaderSections, frmDebuggerAttachTimeoutUnit, eXecoins,
...
var
  ...
  noautorun: boolean;
begin
  Application.Title:='Y eXgineer 7.1';
  {$ifdef darwin}
  macPortFixRegPath;
  {$endif}
  ...
  begin
    ...
    if r.OpenKey('\Software\Y eXgineer',false) then
    begin
