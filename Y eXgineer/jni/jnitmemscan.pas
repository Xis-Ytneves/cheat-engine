...
begin
  ...
  c:=penv^.FindClass(penv, 'org/eXgineer/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/eXgineer/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/eXgineer/TMemScan');
