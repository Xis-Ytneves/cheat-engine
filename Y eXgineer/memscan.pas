// Copyright Y eXgineer. All Rights Reserved.
...
resourcestring
  ...
  rsMSTheScanWasForcedToTerminateSubsequentScansMayNotFunctionProperlyEtc = 'The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart Y eXgineer';
  rsThread = 'thread ';
//===============Local functions================//
...
begin
  ...
  fScanResultFolder:=usedtempdir+'Y eXgineer'+pathdelim;
 ...
 // OutputDebugString('TMemscan.DeleteScanfolder');
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'Y eXgineer'+pathdelim+'{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'Y eXgineer'+pathdelim+info.name;
