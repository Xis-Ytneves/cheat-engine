...
type
  ...
  public
    ...
    procedure AddSelectedAddressToeXTable;
...
procedure THexView.AddSelectedAddressToeXTable;
...
begin
  ...
  DoubleBuffered:=true; // http://eXgineer.org/mantis/view.php?id=280 , no effect for me, but should help those with no theme
