...
begin
  ...
  begin
    ...
    begin
      ...
      fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\Y eXgineer\Lua Highlighter');
    end;
...
begin
  ...
  if fLuaSyntaxHighlighter<>nil then
    fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\Y eXgineer\Lua Highlighter');  //perhaps make this a var
