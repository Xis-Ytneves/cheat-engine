...
type
  TLuaSettings=class    //A wrapper for the registry object to make access to the y eXgineer settings easier and uniform
  private
    freg: Tregistry;
    fpath: string;
...
begin
  ...
  if freg.OpenKey('\Software\Y eXgineer\'+v, true) then
    fpath:=v;
end;
...
begin
  ...
  freg.OpenKey('\Software\Y eXgineer',true);
