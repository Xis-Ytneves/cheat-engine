...
{
eX-E coin handler and simple anti debug code

WARNING: If you read this you will lose all bragging rights on how you bypassed the eX-e-coin system
You can of course say you didn't read this, but you'll know...

Now if you didn't read this to bypass the eX-e-coin system but just want to see how it works, have fun
...
procedure EnableeXEcoinSystem;

procedure decreaseeXECoinCount; stdcall;
function geteXECoinCount: integer;
...
function geteXECoinCount: integer; assembler; nostackframe;
asm
  {$ifdef cpu64}
  lea r8,[_GetCount]
  mov eax,[r8]
...
begin
  if mainthreadhandle<>0 then //most stupid way to save the coins:
    cereg.writeInteger('Used Coins',20-geteXECoinCount);
end;

procedure EnableeXECoinSystem;   //simple solution to all this shittery, remove this function
var
...
begin
  ...
  ShowMessage('New!!! eX-e-coins! Now you can buy eX-e-coins to be able to use Y eXgineer. It''s just like a game!!! Yay!');
