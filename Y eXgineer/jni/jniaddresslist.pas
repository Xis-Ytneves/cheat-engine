...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  ...
  (name: 'GetEntry'; signature: '(I)Lorg/eXgineer/AddressListEntry;'; fnPtr: @addresslist_getEntry),
  (name: 'SetEntry'; signature: '(ILorg/eXgineer/AddressListEntry;)V'; fnPtr: @addresslist_setEntry),
  (name: 'AddEntry'; signature: '(Lorg/eXgineer/AddressListEntry;)I'; fnPtr: @addresslist_addEntry),
...
begin
  ...
  c:=env^.FindClass(env, 'org/eXgineer/AddressList');
  env^.RegisterNatives(env, c, @jnimethods[0], methodcount);

  c:=env^.FindClass(env, 'org/eXgineer/AddressListEntry');
