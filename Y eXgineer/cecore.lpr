...
procedure Java_org_yeXgineer_cecore_f1(PEnv: PJNIEnv; Obj: JObject); cdecl;
var i: integer;

begin
//small test funtion
  log('Java_org_yeXgineer_jnitest_cecore_f1 called');
...
begin
  ...
  begin
    ...
    c:=env^.FindClass(env, 'org/eXgineer/cecore');  //'org/eXgineer/jnitest/cecore';
...
exports Java_org_yeXgineer_cecore_f1;
exports JNI_OnLoad;
