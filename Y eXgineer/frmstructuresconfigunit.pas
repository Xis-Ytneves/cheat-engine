...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Y eXgineer\DissectData',true) then
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\Y eXgineer\DissectData\Font',true) then
...
begin
  ...
  try
    ...
    begin
      ...
      if Reg.OpenKey('\Software\Y eXgineer\DissectData\Font',false) then
      begin
