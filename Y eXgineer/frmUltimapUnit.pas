...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfYeXgineerToMakeUseOfThisFeature = 'Please run the 64-bit version of Y eXgineer to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfYeXgineerToMakeUseOfThisFeature);
  {$endif}
