...
{$ifndef jni}
  if pluginhandler=nil then exit; //Error. Y eXgineer is not properly configured
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                s2:=yeXgineerdir+'includes'+pathdelim+'s1';
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                {$endif}
                  if fileexists(yeXgineerdir+s2) then s1:=yeXgineerdir+s2 else
                    if fileexists(getcurrentdir+ PathDelim+s2) then s1:=getcurrentdir+PathDelim+s2 else
                      if fileexists(yeXgineerdir+s1) then s1:=yeXgineerdir+s1;
                {$ifdef windows}
                end;
                {$endif}
