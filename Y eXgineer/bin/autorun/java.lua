...
function javaInjectAgent()
  ...
  if targetIs64Bit() then
    dllpath=getYeXgineerDir()..[[autorun\dlls\64\CEJVMTI]]
  else
    dllpath=getYeXgineerDir()..[[autorun\dlls\32\CEJVMTI]]
  end
  ...
  JavaSymbols.register() --make these symbols available to all of y eXgineer
...
path:
{$lua}
return "db ';"..getYeXgineerDir().."autorun\\dlls\\32;"..getYeXgineerDir().."autorun\\dlls\\64',0"
{$asm}
