...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantYeXgineerToTryAndFillInTheMostBasicType = 'Do you want eX '
     +'gineer to try and fill in the most basic types of the struct using the '
     +'current address?';
   ...
   rsWrongVersion = 'This structure file was generated with a newer version of '
     +'Y eXgineer. (That means there''s more than likely a new version so '
     +'please update....)';
...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Y eXgineer\DissectData',false) then
    begin
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantYeXgineerToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
