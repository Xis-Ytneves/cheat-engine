...
function loadMemoryScan_thread(t)
  ...
  t.synchronize(function(t)
	  ...
	  dialog.Filter=translate("Y eXgineer Scan files").." (*.CS)|*.CS"
...
s.LoadFromFile(getYeXgineerDir()..[[autorun\images\export128x128.png]])
...
local s=createPicture()
s.LoadFromFile(getYeXgineerDir()..[[autorun\images\import128x128.png]])
local ii=MainForm.mfImageList.add(s.Bitmap)
