...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfYeXgineerToTheCurrent = 'This will attach the debugger of Y eXgineer to the current process.';
  rsDoNotCloseCE = 'If you close Y eXgineer while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfYeXgineerToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfYeXgineerToTheCurrent+' '+rsContinue;
