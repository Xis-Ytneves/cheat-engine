...
resourcestring
  ...
  rsNoStartAddress = 'If you don''t include the header data you''ll have to specify the startaddress yourself when loading the file(That means Y eXgineer wont fill in the '
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        f.WriteBuffer(pchar('EXGINEER')^,11);
        temp:=3; //version
