...
/*
  __android_log_print(ANDROID_LOG_DEBUG, "EXENGING", "Hello \n");

  __android_log_print(ANDROID_LOG_DEBUG, "EXENGING", "module1=%p\n", module);

  module=dlopen("libdvm.so", module);
  __android_log_print(ANDROID_LOG_DEBUG, "EXENGING", "module=%p\n", module);


  X=dlsym(module, "dvmJitStats");
  __android_log_print(ANDROID_LOG_DEBUG, "EXENGING", "After dlsym\n");

  __android_log_print(ANDROID_LOG_DEBUG, "EXENGING", "X=%p\n", X);
