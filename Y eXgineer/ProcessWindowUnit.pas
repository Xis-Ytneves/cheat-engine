...
var
  ...
  i,j: integer;
begin
  s:=yeXgineerdir+'commonProcessesList.txt';
...
begin
  ...
  try
    if reg.OpenKey('\Software\Y eXgineer\Process Window\Font',false) then
...
begin
  ...
  begin
    ...
    reg:=tregistry.create;
    try
      if reg.OpenKey('\Software\Y eXgineer\Process Window\Font',true) then
