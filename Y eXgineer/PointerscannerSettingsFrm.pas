...
begin
  ...
  begin
    ...
    if Reg.OpenKey('\Software\Y eXgineer\'+ClassName, true) then
    begin
    ...
    if Reg.OpenKey('\Software\Y eXgineer\PSNNodeList', false) then
    begin
    ...
    begin
      if iplist[i].host<>'' then
      begin
        if Reg.OpenKey('\Software\Y eXgineer\PSNNodeList\'+iplist[i].host+':'+iplist[i].port,true) then
        begin
...
begin
  ...
  if Reg.OpenKey('\Software\Y eXgineer\'+ClassName, false) then
  begin
  ...
  begin
    ...
    for i:=0 to list.count-1 do
    begin
      if reg.OpenKey('\Software\Y eXgineer\PSNNodeList\'+list[i], false) then
      begin
