...
resourcestring
  ...
  RsEDynControlgineerNotDefined = 'TJvAppStorageSelectList.CreateDialog: DynControlgineer not defined!';
...
resourcestring
  RsDBExceptCaption = 'Database gineer Error';
...
//=== JvDBActions.pas, JvDynControlgineerDBTools.pas =========================
resourcestring
...
//=== JvDynControlgineer.pas =================================================
resourcestring
  RsEIntfCastError = 'component does not support interface';
  RsEUnsupportedControlClass = 'TJvDynControlgineer.RegisterControl: Unsupported ControlClass "%s"';
  RsENoRegisteredControlClass = 'TJvDynControlgineer.CreateControl: No Registered ControlClass "%s"';
  RsENoFocusControl = 'TJvDynControlgineer.CreateLabelControlPanel: AFocusControl must be assigned';

//=== JvDynControlgineerDB.pas ===============================================
resourcestring
  RsEUnassignedField = 'TJvDynControlgineerDB.GetFieldControlType: AField must be assigned';
  RsEUnassignedMultiple = 'TJvDynControlgineerDB.CreateControlsFromDatasourceOnControl: ADataSource, ADataSource.Dataset and AControl must be assigned';
  RsEUnassignedDataSet = 'TJvDynControlgineerDB.CreateControlsFromDatasourceOnControl: ADataSource.Dataset must be active';
